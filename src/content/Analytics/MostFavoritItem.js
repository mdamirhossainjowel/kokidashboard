...
const MostFavoritItem = () => {
  return (
    <div className="card bg-base-100 shadow-xl m-2">
      <div className="card-body">
      <div className="flex justify-between items-center">
          <div>
            <h2>Most Favorit Item</h2>
            <p className="text-xs">Lorem ipsum dolor sit amet, consectetur</p>
          </div>
          <div >
            <label className="flex items-center shadow-sm rounded-full px-2 py-1">
              <h2 className="mr-2 opacity-40 shadow rounded-full px-2 py-1 bg-black text-white">All Categories</h2>
              <h2 className="mr-2 opacity-40">Main Course</h2>
              <h2 className="mr-2 opacity-40">Pizza</h2>
              <h2 className="mr-2 opacity-40">Drink</h2>
              <h2 className="mr-2 opacity-40">Dessert</h2>
            </label>
          </div>
        </div>
...
export default MostFavoritItem;
